...
import phone from '../../public/assets/image/meeyso_phone.png';
import shirt from '../../public/assets/image/longsleeve.png';

export default function OrderSummary({totalCartVal}) {
    return (
        <div className="col-12 col-lg-3 pq-order--summary">
            <div className="container">
                <div className="py-4">
                         <div className="pq--content">
                             <h5 className="pq-content-head">order summary</h5>
                             
                             <div className="card mt-4">
                                 <div className="card-body ">


                                     <div className="pq-card--list">
                                         ...
                                         <a className="pq-card--items">
                                             ...
                                             <div className="col-8 col-lg-7 pq-c-list--ul">
                                                 <ul>
                                                    <li><span>Meeysoo P45 Pro</span></li>
                             ...
                             <div className="card mt-3">
                                 <div className="card-body">
                                     <div className="pq-card--wrap">
                                         <h5 className="pq-card--txthead">Total Cart Value:</h5>
                                         <div className="d-flex align-items-center">
                                             <svg className="pq-card--txtsvg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px"
                                                viewBox="0 0 496.262 496.262" >
                                            <g>
                                                <path d="M477.832,274.28h-67.743v-65.106h67.743c10.179,0,18.43-8.243,18.43-18.424c0-10.182-8.251-18.43-18.43-18.43h-67.743
                                                    V81.982c0-13.187-2.606-22.866-7.743-28.762c-4.882-5.609-11.301-8.219-20.19-8.219c-8.482,0-14.659,2.592-19.447,8.166
                                            ...
                                            <span className="pq-card--txtprice">
                                                <NumberFormat
                                                    value={totalCartVal}
                                                    displayType="text"
